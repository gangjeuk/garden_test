...
# Reference
[[jp/CTF/Basic/assets/ELF from scratch/ELF-64 Object File Format.pdf]]
[[jp/CTF/Basic/assets/ELF from scratch/ELF-64 Object File Format, Version 1.4 1 ELF-64 Object File Format Including HP and HP-UX Extensions.pdf]]
...
![jp/CTF/Basic/assets/ELF from scratch/image-20231005122731689.png](/img/user/jp/CTF/Basic/assets/ELF%20from%20scratch/image-20231005122731689.png)
...
![jp/CTF/Basic/assets/ELF from scratch/image-20231006122304854.png](/img/user/jp/CTF/Basic/assets/ELF%20from%20scratch/image-20231006122304854.png)
...
여기서 자세히 보아야 하는 값은 앞으로 나올 [[jp/CTF/Basic/ELF from scratch#Section header entry\|Section]]과 [[jp/CTF/Basic/ELF from scratch#Program\|Program]]에서 다루어질 Section header, Program header의 위치를 가리키는 *e_phoff*, *e_shoff*이다.

각 헤더는 엔트리로 구성되고 다음과 같은 구조로 되어있다.

![jp/CTF/Basic/assets/ELF from scratch/entries.png](/img/user/jp/CTF/Basic/assets/ELF%20from%20scratch/entries.png)
...
먼저 앞에서 설명한 [[jp/CTF/Basic/ELF from scratch#Section header entry\|Section header entry]]를 다시 한번 상기하자.
...
![jp/CTF/Basic/assets/ELF from scratch/image-20231006152734451.png](/img/user/jp/CTF/Basic/assets/ELF%20from%20scratch/image-20231006152734451.png)
...
![jp/CTF/Basic/assets/ELF from scratch/image-20231006154233302.png](/img/user/jp/CTF/Basic/assets/ELF%20from%20scratch/image-20231006154233302.png)

실제 재배치에 필요한 정보를 가지는  Symbol Table Section 과 Relocation Section은 [[jp/CTF/Basic/ELF from scratch#File header\|위와]]같이 각각 엔트리로 구성되어 있다. 

![jp/CTF/Basic/assets/ELF from scratch/image-20231006184427053.png](/img/user/jp/CTF/Basic/assets/ELF%20from%20scratch/image-20231006184427053.png)
...
## Address Calculation
실제 주소의 계산은 [[jp/CTF/Basic/ELF from scratch#Relocation Entry(.rela, .rel)\|Relocation Entry]]장에서 설명한  r_info를 이용해서 이루어진다.
...
- S: 재배치 후에 해당 심볼의 실제 위치
	- 계산식: ([[jp/CTF/Basic/assets/ELF from scratch/st_value 의미\|st_value]]) + 심볼이 정의된 섹션이 로딩된 어드레스
- P: 재배치 해야하는 부분의 위치
...
## Procedure
사용 프로그램으로는 [[jp/CTF/Basic/ELF from scratch#실습 준비\|2 번째 프로그램(Global)]]을 사용할 것이다.
...
전체적인 구조는 다음과 같다.
![jp/CTF/Basic/assets/ELF from scratch/image-20231010151410269.png](/img/user/jp/CTF/Basic/assets/ELF%20from%20scratch/image-20231010151410269.png)

계산식은 다음과 같고
Address: <span class="green">S</span> + <span class="blue">A</span> - <span class="yellow">P</span>  
위에서 [[jp/CTF/Basic/ELF from scratch#Address Calculation\|주어진 식]]을 조금 더 풀어 쓰면 다음과 같다.
$$
...
구조의 경우 [[jp/CTF/Basic/ELF from scratch#Symbol Table Entry(.symtab)\|Symbol Table Entry]]와 동일한 구조를 가지고 구조체 또한 같은 구조체를 가진다.

Symbol Table Entry와 같이 그림으로 나타내면 다음과 같다.
![jp/CTF/Basic/assets/ELF from scratch/image-20231025113003181.png](/img/user/jp/CTF/Basic/assets/ELF%20from%20scratch/image-20231025113003181.png)
...
자세한 내용은 [[jp/CTF/Basic/assets/ELF from scratch/ELF64_Dyn 의미\|다음과 같다]].
...
자세한 내용은 [[jp/CTF/Basic/GOT, PLT 부터 Dynamic Linking 까지\|jp/CTF/Basic/GOT, PLT 부터 Dynamic Linking 까지]]에서 다룬다.
...
![jp/CTF/Basic/assets/ELF from scratch/image-20231010161636907.png](/img/user/jp/CTF/Basic/assets/ELF%20from%20scratch/image-20231010161636907.png)
