...
# Cheet Sheet
![image-20231011111408136.png](/img/user/Obsidian_test/%EC%A7%80%EC%8B%9D%EB%82%98%EB%88%94/assets/Vim%20%EC%82%AC%EC%9A%A9%EB%B2%95%20%EC%A0%95%EB%A6%AC/image-20231011111408136.png)
...
## 이동
### 단어 단위(word 단위) 이동
![image-20231011111752868.png](/img/user/Obsidian_test/%EC%A7%80%EC%8B%9D%EB%82%98%EB%88%94/assets/Vim%20%EC%82%AC%EC%9A%A9%EB%B2%95%20%EC%A0%95%EB%A6%AC/image-20231011111752868.png)
...
| `"=`       | 표현식 레지스터 [[Obsidian_test/지식나눔/Vim 사용법 정리#즉석해서 계산\|계산]] 등에 사용되는 표현식을 저장하는 레지스터 |

그 외 레지스터
- `"%` - 현재 파일명
- `"#` - 직전에 편집한 파일명
- `".` - 마지막 삽입 본문
- `":` - 마지막 [[Obsidian_test/지식나눔/Vim 사용법 정리#기본 명령어(Ex 명령어)\|Ex 명령]]
- `"/` - 마지막 검색 패턴 
